...
| **Link type discrimination** | Top-down restricted to PRODUCTION/BATCH_TRANSFER/STO_TRANSFER; vendor receipts separate from internal moves | V2 `TraceGraph` edges have no `linkType` field — cannot replicate MB56 link-type filtering |
