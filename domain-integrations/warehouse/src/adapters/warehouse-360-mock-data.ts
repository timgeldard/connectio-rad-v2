...
export const mockWarehouse360Overview = {
  plantId: 'IE10',
  warehouseId: 'WH-IE10-MAIN',
  inboundDueCount: 7,
  ...
  nearExpiryCount: 4,
  reconciliationExceptionCount: 3,
  blockedStockCount: 2,
}

export const mockWarehouse360InboundItems = [
  {
    documentType: 'PO' as const,
    purchaseOrderId: 'PO-240308-0021',
    stockTransportOrderId: '',
    itemId: '00010',
    vendorId: 'VEND-8100234',
    supplyingPlantId: '',
    materialId: 'MAT-RM-RAW-MILK',
    materialDescription: 'Raw Milk — Full Tanker',
    batchId: 'RM-240308-0001',
    plantId: 'IE10',
    storageLocation: 'CHILL-A-BULK-01',
    warehouseNumber: 'WH-IE10-MAIN',
    expectedDate: '2026-05-14T07:00:00.000Z',
    receivedDate: '2026-05-14T07:05:00.000Z',
    quantity: 25000,
    unitOfMeasure: 'L',
    status: 'COMPLETED',
    exceptionReason: '',
  ...
  {
    documentType: 'STO' as const,
    purchaseOrderId: '',
    stockTransportOrderId: 'STO-240309-1002',
    itemId: '00020',
    vendorId: '',
    supplyingPlantId: 'IE20',
    materialId: 'MAT-START-CULTURE-B10',
    materialDescription: 'Starter Culture B10',
    batchId: 'SC-240309-0003',
    plantId: 'IE10',
    storageLocation: 'CHILL-A-007-B03',
    warehouseNumber: 'WH-IE10-MAIN',
    expectedDate: '2026-05-15T08:00:00.000Z',
    receivedDate: '',
    quantity: 15,
    unitOfMeasure: 'KG',
    status: 'IN-TRANSIT',
...
export const mockWarehouse360OutboundItems = [
  {
    deliveryId: 'DEL-8004721',
    deliveryItemId: '000010',
    customerId: 'CUST-382910',
    salesOrderId: 'SO-1003492',
    materialId: 'MAT-CH-EMMENTAL-BLOCK',
    materialDescription: 'Emmental Block 4 kg',
    batchId: 'CH-240307-0038',
    plantId: 'IE10',
    storageLocation: 'CHILL-B-002-A01',
    warehouseNumber: 'WH-IE10-MAIN',
    plannedGoodsIssueDate: '2026-05-14T15:00:00.000Z',
    actualGoodsIssueDate: '2026-05-14T15:10:00.000Z',
    quantity: 960,
    unitOfMeasure: 'KG',
    status: 'SHIPPED',
    exceptionReason: '',
...
export const mockWarehouse360StagingItems = [
  {
    processOrderId: 'PO-240308-3847',
    reservationId: 'RES-002348',
    ...
    storageLocation: 'CHILL-A-007-B03',
    warehouseNumber: 'WH-IE10-MAIN',
    requirementDate: '2026-05-14T08:30:00.000Z',
...
export const mockWarehouse360ExceptionItems = [
  {
    exceptionType: 'quantity-mismatch',
    ...
    batchId: 'CH-240308-0047',
    plantId: 'IE10',
    storageLocation: 'CHILL-A-023-B04',
    warehouseNumber: 'WH-IE10-MAIN',
    quantity: 20,
    unitOfMeasure: 'KG',
    expiryDate: '2026-06-14T00:00:00.000Z',
    daysToExpiry: 27,
    documentId: 'HOLD-2024-00312',
    processOrderId: '',
    deliveryId: '',
    purchaseOrderId: '',
    reason: 'Inventory mismatch: IM show 500kg, WMS shows 480kg.',
    recommendedReviewAction: 'Perform physical cycle count in bin CHILL-A-023-B04.',
  },
]
