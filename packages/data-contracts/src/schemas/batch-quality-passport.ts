...
export const BatchQualityPassportSchema = z.object({
  ...
  inspectionLotCount: z.number().int().optional().describe('[classification: source-field]'),
  productionLotCount: z.number().int().optional().describe('[classification: source-derived]'),
})
