...
export type {
  ...
  EnvMonL4Zone,
  EnvMonL5Coordinate,
  // V2 production schemas — see schemas/environmental-monitoring.ts
  EnvMonStatus,
  EnvMonStatusCounts,
  EnvMonPlantKpis,
  EnvMonSiteSummaryV2,
  ...
  EnvMonMicsResponse,
  EnvMonHeatmapMarker,
  EnvMonHeatmapResponse,
  EnvMonFloorSvgUploadResponse,
